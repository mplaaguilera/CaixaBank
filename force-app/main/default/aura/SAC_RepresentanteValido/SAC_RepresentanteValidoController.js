        ...
        actionGetCaso.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {
                   ...
                   /* if (caso.SAC_TipoDeRepresentante__c != null || caso.SAC_TipoDeDocumento__c != null || caso.SAC_NombreRepresentante__c != null ||
                    ...
                    if((caso.RecordType.DeveloperName == 'SAC_ConsultaSAC' || caso.RecordType.DeveloperName == 'SAC_Reclamacion') && (caso.SAC_NumeroDelDocumento__c != null || caso.SAC_DespachoRepresentante__c != null)){
