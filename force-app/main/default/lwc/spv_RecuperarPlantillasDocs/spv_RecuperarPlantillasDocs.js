...
import recuperarDirectorioRaiz from '@salesforce/apex/SPV_LCMP_RecuperarPlantillas.recuperarDirectorioRaiz';
import cambioCarpeta from '@salesforce/apex/SPV_LCMP_RecuperarPlantillas.cambioCarpeta';
import volverHaciaArriba from '@salesforce/apex/SPV_LCMP_RecuperarPlantillas.volverHaciaArriba';
import obtenerDatosTemplate from '@salesforce/apex/SPV_LCMP_RecuperarPlantillas.obtenerDatosTemplate';
import buscarPlantillas from '@salesforce/apex/SPV_LCMP_RecuperarPlantillas.buscarPlantillas';
...
export default class Spv_RecuperarPlantillasDocs extends LightningElement {
                ...
                if(result){
                    ...
                    this.dispatchEvent(
                        new ShowToastEvent({
                            ...
                            message: 'Se ha cargado correctamente la plantilla.',
                            variant: 'success'
                        })
                    ); 
                    this.dispatchEvent(new RefreshEvent());
                    ...
                    if(this.cambiarPlantilla){
                        // Se manda la información de la plantilla seleccionada al cambiar la plantilla al componente spv_GeneracionDocumento
                        //Custom event en el que se manda la info que queremos enviar al componente padre
                        const sendDataEvent = new CustomEvent('aplicarplantilla', {
                            detail: {
                                cuerpoPlantillaAct: this.cuerpoPlantilla,
                                headerPlantillaAct: this.headerPlantilla,
                                footerPlantillaAct: this.footerPlantilla
                            }
                        });
                        ...
                        // Se manda la información de la plantilla seleccionada al cambiar la plantilla al componente spv_GeneracionDocumento
                        //Custom event en el que se manda la info que queremos enviar al componente padre
                        const sendDataEvent = new CustomEvent('aplicarplantillappio', {
                            detail: {
                                cuerpoPlantillaAct: this.cuerpoPlantilla,
                                headerPlantillaAct: this.headerPlantilla,
                                footerPlantillaAct: this.footerPlantilla
