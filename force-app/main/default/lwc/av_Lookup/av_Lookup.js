...
//DEV
//Labels
import loadingLabel from '@salesforce/label/c.AV_CMP_SuccessEvent';
import noResultsLabel from '@salesforce/label/c.AV_CMP_NoDataFound';
...
export default class Av_Lookup extends LightningElement {
    // Public properties
    @api fieldlabel;
    @api required;
    @api placeholder = '';
    ...
    set selection(initialSelection) {
        ...
        if(!(typeof initialSelection === 'undefined' || initialSelection === null)){
