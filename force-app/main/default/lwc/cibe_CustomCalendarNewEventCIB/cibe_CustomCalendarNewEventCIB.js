...
export default class cibe_CustomCalendarNewEventCIB extends LightningElement {
	...
	changeOwnerEvent(userId, gestorOverWrite ) { 
		console.log('## that.isMonth ', this.isMonth);
		...
		this.maxTime = (gestorOverWrite) ? "18:00:00":"00:00:00";
	...
	renderedCallback() {
		...
		this.maxTime = (this.gestoroverwrite) ? "18:00:00":"00:00:00";
		this.renderDate = new Date(this.currentdate.toString());
