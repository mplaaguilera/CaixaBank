...
//Labels
import ge from '@salesforce/label/c.CIBE_GrupoEconomico';
import nombre from '@salesforce/label/c.CIBE_NombreSimple';

//import
import gruposEconomicos 	    from '@salesforce/apex/CIBE_GEFichaCli_Controller.gruposEconomicos';
...
export default class cibe_GCFichaCli extends NavigationMixin(LightningElement) {
    ...
    @track columns = [
        ...
        { label: this.labels.nombre,       fieldName: 'idGE',    sortable: true,       type: 'url',       cellAttributes: { alignment: 'left'},       typeAttributes: {label: {fieldName: 'nameGE'}, class:'slds-line-height_reset'}}
    ];
    ...
    @track _wiredData;
    @wire(gruposEconomicos, { recordId : '$recordId' })
