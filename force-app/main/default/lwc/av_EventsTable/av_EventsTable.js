...
//apex methods
import getRecords from '@salesforce/apex/AV_EventsTable_Controller.getRecords';

import { refreshApex } from '@salesforce/apex';

 
export default class Av_EventsTable extends LightningElement{
    ...
    wiredGetRecords(result) {
		console.log('Resultado js gon: ' + result.data);
        this.wiredResult = result;
		console.log('error Event:' + result.error);
    if (result.data) {
		console.log('Resultado js gon2: ' + result.data);
