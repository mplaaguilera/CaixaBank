...
//apex methods
import getRecords from '@salesforce/apex/AV_LinkedOppList_Controller.getRecords';

import { refreshApex } from '@salesforce/apex';

 
export default class Av_LinkedOppList extends LightningElement{
	...
	@wire(getRecords, {recordId: '$recordId', sdgApiName: '$sdgApiName'})
