...
export default class cibe_TabListOpportunityComiteDirectorCIB extends LightningElement {
    ...
    columnHeader = [gruposEconomico, grupoComercial, cliente, 'Nombre de la oportunidad', tipoOperacion, producto, importe, divisa, 
        importeEuros, fechaCierre, impactoBalance, impactoComisiones, impactoBalanceEuros, impactoComisionesEuros, etapa, 
        fechaComitePrecios, fechaComiteRiesgo, negocios, redesSegmentos,
        centroCarteras,sectoresPaises, owner, esg, 'Comite Director (SI/NO)',

        numeroDocumento,  name, familia,  probabilidadExito,  motivoCerrada,  diasUltimaGestion, fechaDeAlta, primerPropietario, 	
        gestorCliente, gestorClienteCC, gestorInternacional,
		ecas,algunaOperacionRAR, dictamenALM, visto, nivel, sindicaciones, observaciones,vigenciaOferta];
