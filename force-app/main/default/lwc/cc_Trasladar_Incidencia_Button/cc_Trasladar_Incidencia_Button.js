...
export default class Cc_Trasladar_Incidencia_Button extends LightningElement {
    @api recordId;
    subscription = null;
    currentRecordId;
    ...
    renderedCallback() {
        ...
        let origen = 'trasladarIncidenciaButton';
        let destino = 'trasladarIncidenciaBotonera';
