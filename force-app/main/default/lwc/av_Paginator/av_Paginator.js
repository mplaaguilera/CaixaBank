...
import SearchWords from '@salesforce/label/c.AV_SearchWords';

const DELAY = 300;
const recordsPerPage = [10,20,50,100];
const pageNumber = 1;
...
export default class Paginator extends LightningElement {
    ...
    @api showPageBox = false; //Show/hide search box; valid values are true/false
