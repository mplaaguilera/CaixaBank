...
export default class Csbd_resumenOportunidad extends LightningElement {
	...
	renderedCallback() {
		...
		if (this.muestraCopiaOpp && this.resumenOportunidad !== undefined && this.resumenOportunidad !== null) {
	...
	botonSectionToggleOnclick() {
		this.refs.sectionResumenOportunidad.classList.toggle('slds-is-open');
	}

	iconoContenidoGeneradoConIaOnclick(event) {
		event.preventDefault();
		event.stopPropagation();
		this.botonSectionToggleOnclick();
		this.refs.botonSectionToggle.focus();
	}
}