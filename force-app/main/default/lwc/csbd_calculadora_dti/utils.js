...
export const MENSAJES_INFO = [
	{tipo: 'camposRequeridosInformados', mostrar: false, iconName: 'utility:edit', texto: 'Campos básicos informados.', popoverCamposRequeridos: true},
	{tipo: 'camposRequeridosNoInformados', mostrar: false, iconName: 'utility:edit_gpt', iconoClass: 'iconoError', texto: 'Campos básicos sin informar.', textoStyle: 'color: darkred;', popoverCamposRequeridos: true},
	{tipo: 'cambiosGuardados', mostrar: true, iconName: 'utility:check', texto: 'Modificaciones guardadas.'},
	{tipo: 'cambiosSinGuardar', mostrar: false, iconName: 'utility:warning', iconoClass: 'iconoWarning', texto: 'Hay modificaciones sin guardar.', textoStyle: 'color: darkred;'}
];
...
export function añadirDatosTitulares(oportunidad) {
	const formatNumHijosTitular = numHijos => numHijos === 0 ? 'Sin hijos' : numHijos ? numHijos + ' hijos' : null;
	return {...oportunidad,
		titular1EscalaMaestra: getFieldValue(oportunidad, OPPTY_TITULAR1_ESCALA_MAESTRA) ? 'EM ' + getFieldValue(oportunidad, OPPTY_TITULAR1_ESCALA_MAESTRA) : null,
		titular1Edad: getFieldValue(oportunidad, OPPTY_TITULAR1_EDAD) ? getFieldValue(oportunidad, OPPTY_TITULAR1_EDAD) + ' años' : null,
		titular1EstadoCivil: getFieldValue(oportunidad, OPPTY_TITULAR1_ESTADO_CIVIL),
		titular1NumHijos: formatNumHijosTitular(getFieldValue(oportunidad, OPPTY_TITULAR1_NUM_HIJOS)),
		titular2EscalaMaestra: getFieldValue(oportunidad, OPPTY_TITULAR2_ESCALA_MAESTRA) ? 'EM ' + getFieldValue(oportunidad, OPPTY_TITULAR2_ESCALA_MAESTRA) : null,
		titular2Edad: getFieldValue(oportunidad, OPPTY_TITULAR2_EDAD) ? getFieldValue(oportunidad, OPPTY_TITULAR2_EDAD) + ' años' : null,
		titular2EstadoCivil: getFieldValue(oportunidad, OPPTY_TITULAR2_ESTADO_CIVIL),
		titular2NumHijos: formatNumHijosTitular(getFieldValue(oportunidad, OPPTY_TITULAR2_NUM_HIJOS))
	};
}