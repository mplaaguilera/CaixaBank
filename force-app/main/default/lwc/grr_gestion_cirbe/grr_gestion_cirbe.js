...
const MI_RECORDTYPE = 'GRR_Cirbe';
import { NavigationMixin } from 'lightning/navigation';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class Grr_gestion_cirbe extends NavigationMixin(LightningElement) {
    ...
    @wire(getGestionesByCaseId, { caseId: '$recordId', recordType:  MI_RECORDTYPE })
     ...
     handleSuccess(event) {
        ...
        get tituloGestiones() {
            return `Cirbe y BBDD externas (${this.gestiones.length})`;
          }
