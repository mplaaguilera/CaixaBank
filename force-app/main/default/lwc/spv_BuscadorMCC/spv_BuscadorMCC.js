...
import buscarResultados from '@salesforce/apex/SPV_LCMP_BuscadorMCCController.buscarResultados';
import buscarGruposDetalle from '@salesforce/apex/SPV_LCMP_BuscadorMCCController.buscarGruposDetalle';
import actualizarCaso from '@salesforce/apex/SPV_LCMP_BuscadorMCCController.actualizarCaso';

import obtenerClasificacionActual from '@salesforce/apex/SPV_LCMP_BuscadorMCCController.obtenerClasificacionActual';



export default class Spv_BuscadorMCC extends LightningElement {
    ...
    wiredClasificacionActual({ error, data }) {
        if(data) {
            console.log('cambioMCC ' + this.cambioMCC);
            if(this.cambioMCC) {
