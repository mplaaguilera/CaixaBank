...
import retrieveRecords from '@salesforce/apex/EV_DataTablePO_Controller.searchLookup';


let i = 0;
export default class Ev_multiSelectLookup extends LightningElement {
    ...
    //introducimos api disable de padre
    @api disabled = false;
