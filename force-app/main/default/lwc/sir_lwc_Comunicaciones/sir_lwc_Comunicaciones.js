...
import getComunicaciones from '@salesforce/apex/SIR_LCMP_Comunicaciones.getComunicaciones';
/* Inicio Modificacion HSC 04/10/2022 -- US424115 */
import getQueryAcciones from '@salesforce/apex/SIR_LCMP_Comunicaciones.getQueryAcciones';
import getQueryReports from '@salesforce/apex/SIR_LCMP_Comunicaciones.getQueryReports';
...
export default class Sir_lwc_Comunicaciones extends LightningElement {
    //@track visible = false;
    ...
    @wire(getQueryAcciones, {
        ...
        if(result.data){ 
            ...
            getQueryReports({url: (window.location).toString()}).then(result => {           
                ...
                this.informeAccionesHoy =  '/lightning/r/Report/' +  this.resultQueryReport[0].Id + '/view';                        
            })
            .catch(error => {
