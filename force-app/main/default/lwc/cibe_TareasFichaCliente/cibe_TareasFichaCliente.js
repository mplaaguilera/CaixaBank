...
export default class cibe_TareasFichaCliente extends NavigationMixin(LightningElement) {
    ...
    @track columns = [
        ...
        { label: this.labels.asunto,                  fieldName: 'idTask',                  sortable: true,       type: 'url',       cellAttributes: { alignment: 'left' },    initialWidth : 250,       typeAttributes: {label: {fieldName: 'asunto'}}},
        { label: this.labels.estado,                  fieldName: 'estado',                  sortable: true,       type: 'text',      cellAttributes: { alignment: 'left' },    initialWidth : 200},
        { label: this.labels.fechaVencimiento,        fieldName: 'fechaVencimiento',        sortable: true,       type: 'date',      cellAttributes: { alignment: 'right' },   initialWidth : 300,       typeAttributes: {day: "2-digit", month: "2-digit", year: "numeric"}},
