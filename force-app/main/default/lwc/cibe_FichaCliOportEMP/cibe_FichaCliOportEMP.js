...
//import
import opportunities 	    from '@salesforce/apex/CIBE_FichaCliOportEMP_Controller.opportunities';

export default class cibe_FichaCliOportEMP extends NavigationMixin(LightningElement) {
    ...
    getValues(wireResult) {
        ...
        console.log(wireResult);
        console.log(wireResult.data);
        console.log(wireResult.error);
