...
export default class Cc_TrasladarColaborador_Button extends LightningElement {
    @api recordId;
    subscription = null;
    currentRecordId;
    ...
    renderedCallback() {
        ...
        let origen = 'trasladarColaboradorButton';
        let destino = 'trasladarColaboradorBotonera';
