...
import getRecordSObject from '@salesforce/apex/CBK_DataTableView_Controller.retriveRecords';

export default class Cbk_dataTableView extends LightningElement {
    data = [];
    @api columns = [];
	@api recordId;
	@api query;
