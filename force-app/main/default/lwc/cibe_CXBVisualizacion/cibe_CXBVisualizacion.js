...
//import
import getRecords 	        from '@salesforce/apex/CIBE_CXBDisplayController.getRecordsCIB';
...
export default class Cibe_CXBVisualizacion extends NavigationMixin(LightningElement) {
  ...
  //  @track options2 = optionsEdit;
    ...
    getValues(wireResult) {
        ...
        if(data){
            ...
            this.dataValues = this.sortData(this.dataValues, 'empleado', 'asc');
