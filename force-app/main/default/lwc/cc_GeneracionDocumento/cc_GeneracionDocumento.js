...
import compruebaDocumentoRedaccion from '@salesforce/apex/CC_GeneracionDocumento.compruebaDocumentoRedaccion';
import generarDocumentoRedaccion from '@salesforce/apex/CC_GeneracionDocumento.generarDocumentoRedaccion';
import getRuta from '@salesforce/apex/CC_GeneracionDocumento.getRuta';
import { RefreshEvent } from 'lightning/refresh';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';


export default class CC_GeneracionDocumento extends LightningElement {
    ...
    generarDoc(){
        ...
        generarDocumentoRedaccion({'id': this.idRedaccion }).then(result => {
            ...
            console.log('antes del toast1');
        this.showToast();
        console.log('fuera del toast1');
                this.mostrarEdicion = false;
                this.botonGenerar = true;
                let dataToSend = true;
                //Custom event en el que se manda la info que queremos enviar al componente padre
