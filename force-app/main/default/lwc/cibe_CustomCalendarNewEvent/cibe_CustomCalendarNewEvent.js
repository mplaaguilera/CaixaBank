...
export default class cibe_CustomCalendarNewEvent extends LightningElement {
	...
	changeOwnerEvent(userId, gestorOverWrite) {
		...
		this.maxTime = (gestorOverWrite) ? "22:00:00" : "00:00:00";
	...
	renderedCallback() {
		...
		this.maxTime = (this.gestoroverwrite) ? "22:00:00" : "00:00:00";
		this.renderDate = new Date(this.currentdate.toString());
