...
export default class Cc_MultiPickListLWC extends LightningElement {

    @api options;
    @api franjaPorDefecto; // se utiliza unicamente para el monitor online
    @api selectedValue;
    @api selectedValues = [];
    @api label;
    @api disabled = false;
    ...
    connectedCallback() {
        setTimeout(() => {
            ...
            if (value || values) {
                ...
                for (var i = 0; i < optionData.length; i++) {
                    if (this.multiSelect) {
                        ...
                        if(this.franjaPorDefecto === optionData[i].value){

                            this.values.push(optionData[i].value);  
                            optionData[i].selected = true;
                            count++;
                            this.franjaPorDefecto = null;
                        }
                ...
                if (this.multiSelect){
                    this.searchString = count + ' Elementos Seleccionados';
                }else{
            ...
            this.selectedValues = this.franjaPorDefecto;
        }, 3000);
    ...
    @api clearAll() {
        ...
        this.searchString = 0 + ' Elementos Seleccionados';
        this.selectedValues = [];
        this.optionData = optionData;
    }
